        ...
        <div className="flex-1 overflow-hidden">
          <div className="h-screen p-4">
            <div className="h-full flex gap-4">
              {/* Sources Panel */}
              <div className="w-1/4 border border-gray-300 rounded p-4 bg-white overflow-y-auto">
              ...
              {/* Main Content Area */}
              <div className="w-3/4 border border-gray-300 rounded p-4 bg-white overflow-y-auto">
                {files.length === 0 ? (
